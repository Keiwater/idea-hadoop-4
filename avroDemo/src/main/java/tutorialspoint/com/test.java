...
public class test extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5062293294757549718L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"test\",\"namespace\":\"tutorialspoint.com\",\"fields\":[{\"name\":\"Name\",\"type\":\"string\"},{\"name\":\"Id\",\"type\":\"int\"}]}");
   ...
   */
  public test(CharSequence Name, Integer Id) {
    this.Name = Name;
    this.Id = Id;
  }
